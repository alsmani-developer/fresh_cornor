      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title" id="lable">عرض اشكال المنتج</h3>
            ...
            <div class="card-tools">
              ...
              >
                اضافه <i class="fas fa-shape-plus fa-fw"></i>
              </button>
            </div>
          </div>
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover">
              <tbody>
                <tr>
                  <th>رقم شكل المنتج</th>
                  <th>الاسم عربي</th>
                  <th>الاسم انجليزي</th>
                </tr>

                <tr v-for="(shape, index) in shapes.data" :key="shapes.id">
                  <td>{{ shape.id }}</td>
                  <td>{{ shape.ar_name }}</td>
                  <td>{{ shape.en_name }}</td>
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="editMode ? updateshape() : createshape()">
            ...
            <div class="modal-footer">
              ...
              <button v-show="editMode" shape="submit" class="btn btn-primary">
                تعديل
              </button>
              <button v-show="!editMode" shape="submit" class="btn btn-primary">
                انشاء
