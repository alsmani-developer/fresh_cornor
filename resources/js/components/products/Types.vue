          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                    <button class="btn btn-success" data-toggle="modal" data-target="#addNew" @click="openModalWindow">اضافه <i class="fas fa-type-plus fa-fw"></i></button>
                </div>
              </div>
                ...
                <table class="table table-hover">
                  <tbody>
                   ...
                   <tr
                    ...
                    <td>
                        <a href="#" data-id="type.id" @click="editModalWindow(type)">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    ...
                    <h5 v-show="!editMode" class="modal-title" id="addNewLabel">اضافه نوع جديد</h5>
                    <h5 v-show="editMode" class="modal-title" id="addNewLabel">تعديل بيانات النوع</h5>
...
<div class="modal-body">
     <div class="form-group">
        <input v-model="form.ar_name" type="text" name="ar_name"
     ...
     <div class="form-group">
        <input v-model="form.en_name" type="text" name="en_name"
