...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align: center"> تعديل بيانات  {{$admin->name}}</div>

                <div class="card-body">
                    @include('multiauth::message')
                    <form action="{{route('admin.update',[$admin->id])}}" method="post" dir="rtl">
                        @csrf @method('patch')
                        ...
                        <div class="form-group row">
                            <label for="role_id" class="col-md-4 col-form-label text-md-right"> تعديل الصالحيه</label>

                            <select name="role_id[]" id="role_id" class="form-control col-md-6 {{ $errors->has('role_id') ? ' is-invalid' : '' }}" multiple>
                                <option selected disabled> اختر صالحيه</option>
                        ...
                        <div class="form-group row">
                            <label for="active" class="col-md-4 col-form-label text-md-right">تنشيط</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('admin.show') }}" class="btn btn-danger btn-sm float-right">رجوع</a>
                            </div>
                        </div>
                    </form>
                </div>
